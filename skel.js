...
SkeletonAnimated.prototype.Initialize = function (gl) {
	...
	this.mShaders = [];
	// TODO: OR NULL!
	this.mShaders.push(this.mCanGPUSkinUsingUniforms? LoadShaderFromFile(gl, "skel_skinned.vert", "solid.frag") : null);
	this.mShaders.push(this.mCanGPUSkinUsingTextures? LoadShaderFromFile(gl, "skel_tex_skinned.vert", "solid.frag") : null);
	this.mShaders.push(LoadShaderFromFile(gl, "skel_static.vert", "solid.frag"));

	this.mWomanMesh = new Mesh(gl, "Skeleton.mesh");
	this.mWomanSkeleton = new Skeleton();
	this.mWomanSkeleton.LoadFromFile("Woman.skel");
	this.mWalkingClip = new Clip();
	this.mWalkingClip.LoadFromFile("Punching.anim");
